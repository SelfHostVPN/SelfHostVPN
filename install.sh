...
docker run --detach --restart always --network=Global --ip 192.168.10.110 --name Applications.Yacy -e VIRTUAL_PORT=8090 -e VIRTUAL_HOST=yacy.hole -v /home/Volumes/System/Yacy:/opt/yacy_search_server/DATA --log-opt max-size=200m --log-opt max-file=2 yacy/yacy_search_server:latest
